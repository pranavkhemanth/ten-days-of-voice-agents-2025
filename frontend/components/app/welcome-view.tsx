      ...
      >
        {!started && (
          ...
          w-full max-w-sm mx-4 md:mx-0">
            ...
            <div className="absolute top-10 left-6 text-3xl opacity-90 -rotate-12 pointer-events-none select-none drop-shadow-[0_0_12px_rgba(253,224,71,0.5)]">
              🎭
            </div>
            <div className="absolute bottom-4 right-6 text-2xl opacity-90 rotate-10 pointer-events-none select-none drop-shadow-[0_0_12px_rgba(239,68,68,0.5)]">
              🤣
            </div>
            <div className="absolute top-1/2 left-2 text-xl opacity-90 -rotate-20 pointer-events-none select-none drop-shadow-[0_0_12px_rgba(59,130,246,0.5)]">
              🎤
            </div>
